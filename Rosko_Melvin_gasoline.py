...
Description:
Prints the pounds of carbon dioxide produced by a given
number of gallons of gasoline as well as the cost of the gasoline
and the number of crude oil barrels needed to make the given amount
of gasoline.
"""
